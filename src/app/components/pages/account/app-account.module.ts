...
import { AccountHistoryComponent } from './history/app-account-history.component';
...
@NgModule({
  ...
  declarations: [AccountComponent, AccountIndexComponent, AccountSignInComponent, AccountRegisterComponent, AccountRecoveryComponent, AccountHistoryComponent],
